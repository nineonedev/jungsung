        ...
        <main>
            ...
            <section class="no-section-xl no-main-philo --full-height">
                <div class="no-container-md no-main-philo__container">
                    <div class="no-main-philo__card" <?= $AOS_FADE_UP ?>>
                        <em class="no-main-philo__char" title="精誠">
                            <svg  viewBox="0 0 126 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="no-section-xl no-main-solution">
                <div class="no-container-xl no-main-solution__container">
                    <div class="no-main-solution__head">
                        <h2 class="no-heading-xl" <?= $AOS_FADE_UP ?>>
                            건물관리의 모든 것,<br> 
                            정성종합관리의 토탈 솔루션
                        </h2>
                    </div>
                    <div class="no-main-solution__body no-pd-4xl--t">
                        <ul class="no-main-solution__list">
                            ...
                            ?>
                            <li class="no-main-solution__item" <?= $AOS_FADE_UP ?>>
                        ...
                        <div class="no-main-solution__cta">
                            <a href="/pages/services/facility-management.php" <?= $AOS_FADE_UP ?> class="no-btn no-btn--md no-btn--primary">
                                <span>사업영역 보러가기</span>
                                <i class="fa-light fa-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="no-main-feature__body no-pd-4xl--t">
                        <div class="no-main-feature__div">
                            <ul class="no-main-feature__list">
                                ...
                                <li class="no-main-feature__item"  <?= $AOS_FADE_UP ?>>
                            ...
                            <div class="no-main-feature__cta">
                                <a href="/pages/services/ceo-message.php"  <?= $AOS_FADE_UP ?> class="no-btn no-btn--md no-btn--primary">
                                    <span>회사소개 보러가기</span>
                                    <i class="fa-light fa-arrow-right"></i>
                                </a>
                            </div>
                            <div class="no-main-feature__pic">
                                <div class="no-main-feature__image" <?= $AOS_FADE_UP ?>>
            ...
            <section class="no-section-xl no-main-pofol">
                <div class="no-container-xl">
                    <div class="no-main-pofol__top">
                        <div class="no-main-pofol__total" <?= $AOS_FADE_UP ?>>
                        ...
                        <div class="no-main-pofol__head"  <?= $AOS_FADE_UP ?>>
                    ...
                    ?>
                    <div class="no-main-pofol__carousel no-pd-4xl--t swiper" <?= $AOS_FADE_UP ?> id="main-pofol-swiper">
                        ...
                        <div class="no-main-pofol__control no-pd-4xl--t" <?= $AOS_FADE_UP ?>>
            ...
            <section class="no-section-xl no-main-comm no-main-notice">
                <div class="no-container-xl">
                    <div class="no-main-comm__div">
                        <div class="no-main-comm__head" <?= $AOS_FADE_UP ?>>
                        ...
                        <div class="no-main-comm__body no-main-comm__body--notice">
                            <ul class="no-main-notice__list" <?= $AOS_FADE_UP ?>>
            ...
            <section class="no-section-xl no-main-comm no-main-resource">
                <div class="no-container-xl">
                    <div class="no-main-comm__div">
                        ...
                        <div class="no-main-comm__body no-main-comm__body--resource" <?= $AOS_FADE_UP ?>>
            ...
            <section class="no-section-xl no-main-contact">
                <div class="no-container-xl no-main-contact__container">
                    <div class="no-main-contact__content" <?= $AOS_FADE_UP ?>>
